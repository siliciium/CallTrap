<p align="center">
<img alt="image" width="700" src="https://github.com/siliciium/CallTrap/blob/main/Windows/PBAP-PCE/Images/_1.png" />
</p>
...
# ⚡︎ Utilisation
- L'appareil Bluetooth pour lequel vous souhaitez obtenir les informations (probabalement un smartphone) doit être appairés avant de pouvoir procéder à une analyse. Lors de l'appairage vous devez vous assurez de cocher `l'autorisation Bluetooth liée au partage du carnet d’adresses` sur l'appareil distant. Le nom exact varie selon les marques, mais les systèmes Android utilisent des formulations proches.
